        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="text-center p-8 hover:shadow-lg transition-shadow">
              ...
              <div className="space-y-2 text-gray-600">
                <p>Sur la route de l’aéroport en diagonale du commissariat tampis</p>
                <Button asChild variant="outline" size="sm" className="mt-4 bg-transparent">
                  <Link href="https://www.google.com/maps?q=sur+la+route+de+l'aéroport+en+diagonale+du+commissariat+tampis+Congo+Brazzaville" target="_blank" rel="noopener noreferrer">Voir sur Google Maps</Link>
                </Button>
              </div>
            </Card>
